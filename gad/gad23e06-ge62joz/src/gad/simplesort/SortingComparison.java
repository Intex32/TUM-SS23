...
public final class SortingComparison {
    ...
    public static void main(String[] args) {
        {
            var alg = new DualPivotQuicksort(DualPivotFinder.getMedianPivotDistributed(5), 0);
            var arr = new int[]{1, 9, 2, 8, 3, 7, 4, 6, 5, 0, 2, 4, 8};
            alg.sort(arr, new StudentResult());
            System.out.println(Arrays.toString(arr));
        }

        /*{
            var alg = new Quicksort(PivotFinder.getMedianPivotDistributed(3), 0);
            var arr = new int[] { 1, 9, 2, 8, 3, 7, 4, 6, 5 };
            alg.sort(arr, new StudentResult(), 2, 6);
            //System.out.println(Arrays.toString(arr));
        }*/
