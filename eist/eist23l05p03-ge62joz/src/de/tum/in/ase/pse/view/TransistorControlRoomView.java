...
public class TransistorControlRoomView extends ControlRoomView {
    ...
    public void update(Machine currMachine) {
         ...
         */
        getCurrentTemperatureDisplay().setText(String.valueOf(currMachine.getCurrentTemperature()));
        getCurrentVoltageDisplay().setText(String.valueOf(currMachine.getCurrentVoltage()));
        TransistorMachine transistorMachine = (TransistorMachine) currMachine;
        transSizeDisplay.setText(String.valueOf(transistorMachine.getTransistorSize()));
