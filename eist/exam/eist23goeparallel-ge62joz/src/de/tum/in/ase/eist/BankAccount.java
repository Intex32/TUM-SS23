...
public class BankAccount {
    ...
    public void transfer(BankAccount destination, long amount) {
        ...
        var first = accountId < destination.accountId ? this : destination;
        var second = first == this ? destination : this;
        secureTransfer(destination, amount, first.securityMutex, second.securityMutex);
    }
